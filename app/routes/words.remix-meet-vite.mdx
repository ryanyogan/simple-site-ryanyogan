...
import { AnimatedName } from "./_components/animated-name"
...
It's funny now, but I have been trying to write for years lol.  Here is an interesting look
at my most recent attempt, and what it took to get here.
...
It took me a week to write a post, I had to build two seperate sites. I had to get a little silly and have some fun to
actually deliver hahahaha.
...
So here I am, for the first time in years off Vercel on a personal site, being different, that 
part feels a little weird. 😱
